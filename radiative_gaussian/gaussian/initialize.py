...
sys.path.append("./")
from radiative_gaussian.gaussian.gaussian_model import GaussianModel
from radiative_gaussian.arguments import ModelParams
from radiative_gaussian.utils.graphics_utils import fetchPly
from radiative_gaussian.utils.system_utils import searchForMaxIteration
...
def initialize_gaussian(gaussians: GaussianModel, args: ModelParams, loaded_iter=None):
    if loaded_iter:
        ...
        if args.ply_path == "":
            ...
            print("Using user-specified ply path at {} for initialization.".format(args.ply_path))
