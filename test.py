...
sys.path.append("./")
from radiative_gaussian.arguments import (
    ModelParams,
    PipelineParams,
    get_combined_args,
)
...
from radiative_gaussian.utils.general_utils import safe_state, t2a
...
def testing(
    ...
    return train_2d, test_2d, result_3d
...
def evaluate_volume(
    ...
    return {"psnr_3d": psnr_3d, "ssim_3d": ssim_3d,}
...
def evaluate_render(save_path, name, views, gaussians, pipeline):
    ...
    return {"psnr_2d": psnr_2d, "ssim_2d": ssim_2d,}
